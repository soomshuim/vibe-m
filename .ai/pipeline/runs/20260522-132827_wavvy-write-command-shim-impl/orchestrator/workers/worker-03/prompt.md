...
- Mode: repair_only
- Repair-only: true
- Base worker: worker-02
- Do not rewrite or replace the base worker implementation wholesale; repair defects, integrate evidence, and record any redesign need as `NEEDS_USER_DECISION`.
