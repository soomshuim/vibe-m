...
Research Wavvy-specific lyric-writing evidence: synthesize current popular Pop/R&B/Neo-soul lyric narration patterns, local Wavvy SSOT rules, and prior 17-00 research into a bounded baseline. Write research artifacts only; do not implement the skill or harness.
...
- Execution group: `serial-research`
- Depends on: none
